...
# myMap = loader.loadModel(myMap.mapFile)
# myMap.reparentTo(render)
# myMap.mapRootNode = myMap.find("-PandaNode")

egg2 = loader.loadModel("models/ball_and_board3.egg")
walls = egg2.find("**/Cube")
odeBoxGeom()
...
#wall2 = add_plane_to_physics(plane2, space1, 0, 1, 0, -1)
