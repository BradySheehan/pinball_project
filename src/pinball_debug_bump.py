...
#extract bumper
egg_bumper = loader.loadModel("models/bumper2.egg")
egg_bumper2= loader.loadModel("models/bumper2.egg")
bumper = egg_bumper.find("**/Cube")
bumper2 = egg_bumper2.find("**/Cube")
bumper.setPos(3,.75, .25)
bumper2.setPos(3,-.75, .25)
bumper.setHpr(90,0,0)
bumper2.setHpr(-90,0,0)
bumper.reparentTo(render)
bumper2.reparentTo(render)
