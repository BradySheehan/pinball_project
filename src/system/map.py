...
class map(object):
	def __init__(self):
		...
		self.mapFile = "../models/box.egg"
		#self.mapFile = "./graphics/models/mapbox_in_edit_mode.egg"

        #added by Donovan 
        self.mapRootNode = "../models/box.egg"
	...
	def create(self):
		...
		## self.mapRootNode is null because we aren't finding "-PandaNode"
