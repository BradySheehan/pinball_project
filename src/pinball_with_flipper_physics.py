...
class Table():
    ...
    def setup_ode_world_params(self):
        ...
        self.world.setSurfaceEntry(
            0, #surface ID
            2, #surface ID
            OdeUtil.getInfinity(),  #Friction (mu)
            0.1,  # bounce
            0.0,  # bounce velocity (minimum velocity a body must have before it bounces)
            0.0,
            0.0000,
    ...
    def add_flipper_hinge_to_physics(self, hingeNP):
        ...
        self.space1.setSurfaceType(hinge, 2)
    ...
    def move_right_flipper_up(self):
        ...
        self.flipper_body_right.setForce(-10.0, 0.0, 0.0)
        ...
        # hpr = Quat(self.flipper_body_right.getQuaternion()).getHpr()
        # self.h_right = hpr[0]
