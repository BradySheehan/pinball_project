...
class Table():
    ...
    def move_left_flipper_up(self, task):
            ...
            print self.flipper_body_left.getPosition(), self.flipper_body_left.getQuaternion()

            # self.pivot_left.setPosQuat(
            # self.flipper_body_left.getPosition(), Quat( self.flipper_body_left.getQuaternion()) )
            self.contactgroup.empty()  # Clear the contact joints
    ...
    def move_right_flipper_up(self, task):
        ...
        render,self.flipper_body_right.getPosition(), Quat( self.flipper_body_right.getQuaternion()) )
        print self.flipper_body_right.getPosition(), self.flipper_body_right.getQuaternion()
